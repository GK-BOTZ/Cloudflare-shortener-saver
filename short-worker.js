...
async function handleRequest(request) {
  ...
  // Attempt to shorten URL (text format)
  let short = '';
  ...
  // Fallback to JSON format if text format fails
  if (!short) {
  ...
  // Use original URL if shortening fails
  if (!short) {
    short = longUrl;
  }

  // Encrypt the shortened URL and return
